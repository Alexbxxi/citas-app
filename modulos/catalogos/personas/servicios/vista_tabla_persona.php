...
<div class="row">
	<div class="col-sm-12">
		...
		<table id="tablePersonas" class="col-sm-12 col-md-12 col-lg-12 table table-hover table-condensed table-bordered">
			<thead>
				<tr>
			...
			<tbody>
				<?php foreach ($personas as $persona) { ?>
					<tr onmouseover="cambiaColor(this)">
		...
		<div class="modal-content">
			...
			<form id="addper" method="POST" action="modulos/catalogos/personas/servicios/agregarpersonas.php" onsubmit="return validarFormulario()">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" data-dismiss="modal" id="agregarPersona">Agregar</button>
